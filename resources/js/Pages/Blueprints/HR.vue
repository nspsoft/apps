...
import { UsersIcon, WrenchScrewdriverIcon } from '@heroicons/vue/24/outline';
...
<template>
    ...
    <AppLayout :title="title">
        <div class="rounded-2xl glass-card p-12 text-center">
            <div class="flex h-20 w-20 items-center justify-center rounded-3xl bg-indigo-500/10 text-indigo-400 mx-auto mb-6">
            ...
            <p class="text-slate-500 dark:text-slate-400 max-w-md mx-auto mb-6 leading-relaxed">
                This Human Resources module is currently in the <strong>Blueprinting Phase</strong>. It will manage the employee directory, attendance tracking, and automated payroll processing.
            </p>
