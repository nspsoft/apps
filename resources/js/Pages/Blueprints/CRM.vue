...
import { UserPlusIcon, WrenchScrewdriverIcon } from '@heroicons/vue/24/outline';
    ...
    <AppLayout :title="title">
        <div class="rounded-2xl glass-card p-12 text-center">
            ...
            <p class="text-slate-500 dark:text-slate-400 max-w-md mx-auto mb-6 leading-relaxed">
                This CRM module is currently in the <strong>Blueprinting Phase</strong>. It will help manage leads, track opportunities, and run marketing campaigns to grow your business.
            </p>
