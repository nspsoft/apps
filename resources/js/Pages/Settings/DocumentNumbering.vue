...
import { HashtagIcon, WrenchScrewdriverIcon } from '@heroicons/vue/24/outline';
</script>
    ...
    <AppLayout title="Document Numbering">
        <div class="rounded-2xl glass-card p-12 text-center">
            <div class="flex h-20 w-20 items-center justify-center rounded-3xl bg-blue-500/10 text-blue-400 mx-auto mb-6">
                <HashtagIcon class="h-10 w-10" />
            </div>
            <h3 class="text-xl font-bold text-slate-900 dark:text-white mb-2">Document Numbering</h3>
            <p class="text-slate-500 dark:text-slate-400 max-w-md mx-auto mb-6 leading-relaxed">
                This module is currently under development. Soon you will be able to customize serial number formats for SO, PO, SJ, and other documents here.
            </p>
