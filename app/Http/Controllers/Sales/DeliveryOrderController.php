...
class DeliveryOrderController extends Controller
{
    ...
    public function bulkCreateInvoice(Request $request): \Illuminate\Http\RedirectResponse
    {
        ...
        try {
            ...
            $invoice->invoice_number = \App\Models\SalesInvoice::generateInvoiceNumber($customer->id, $deliveryOrders->first()->delivery_date);
        ...
        try {
            return \DB::transaction(function () use ($deliveryOrder) {
                ...
                $invoice = \App\Models\SalesInvoice::create([
                    ...
                    'invoice_number' => \App\Models\SalesInvoice::generateInvoiceNumber($deliveryOrder->customer_id, $deliveryOrder->delivery_date),
